...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="container">
                <form class="form-horizontal" action="../reportes/repMensual.jsp">
                    <div class="row">
    ...
    <script>
                                ...
                                function generaExcel() {
                                    ...
                                    if (unidad === "" || origen === "" || hora_ini === "" || hora_fin === "") {
                                        ...
                                        window.location = "../reportes/gnrRepMensual.jsp?id_tip=" + id_tip + "&unidad=" + unidad + "&id_origen=" + origen + "&hora_ini=" + hora_ini + "&hora_fin=" + hora_fin + "";
                                    }
