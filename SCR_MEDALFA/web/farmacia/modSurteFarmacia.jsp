                                            ...
                                            <div class="col-lg-8">
                                                <table class="table table-bordered">
                                                    ...
                                                    <%
                                                        ...
                                                        ResultSet rset2 = con.consulta("select cla_pro, des_pro, can_sol, cant_sur, fol_det, lote,DATE_FORMAT(caducidad,'%d/%m/%Y') AS caducidad from recetas where fol_rec = '" + rset.getString(1) + "'  ");
                                                        while (rset2.next()) {
