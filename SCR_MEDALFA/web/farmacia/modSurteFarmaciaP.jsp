                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <%
                                    try {
                                        con.conectar();
                                        ResultSet rset = con.consulta("SELECT DISTINCT(fol_rec), nom_com, fecha_hora, id_rec from recetas where fol_rec like '%" + fol_rec + "%' and nom_com like '%" + nom_pac + "%' and transito=0 and baja=2 and id_tip='1' order by id_rec asc ;");
                                        while (rset.next()) {
                                %>
                                            ...
                                            <div class="col-lg-10">
                                                <table class="table table-bordered">
                                                    ...
                                                    <%
                                                        ...
                                                        ResultSet rset2 = con.consulta("select cla_pro, des_pro, can_sol, cant_sur, fol_det, lote,DATE_FORMAT(caducidad,'%d/%m/%Y') AS caducidad from recetas where fol_rec = '" + rset.getString(1) + "' and can_sol!=cant_sur ");
                                                        while (rset2.next()) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" class="form-control" value="<%=dife%>" name="sur_<%=rset2.getString(5)%>" /></td>
