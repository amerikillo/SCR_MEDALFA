...
<%
    ...
    response.setHeader("Content-Disposition", "attachment;filename=\"Rep_Mensual_"+request.getParameter("hora_ini")+"-"+request.getParameter("hora_fin")+".xls\"");
%>
...
<html>
    ...
    <body>
        ...
        %>
        <div class="letra"><a href="../farmacia/repMensFarmacia.jsp">Regresar</a></div>
        <%
            try {
        ...
        <table border="1" width="800px" class="letra">
            ...
            <%
                con.conectar();
                ResultSet rset = con.consulta("select * from receta_reportes where des_uni = '" + request.getParameter("unidad") + "' and id_tip = '" + request.getParameter("id_tip") + "' and fecha_hora between '" + df2.format(df3.parse(request.getParameter("hora_ini"))) + " 00:00:01' and '" + df2.format(df3.parse(request.getParameter("hora_fin"))) + " 23:59:59' group by cla_pro order by cla_pro+0 ");
                while (rset.next()) {
