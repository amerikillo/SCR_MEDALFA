    ...
    <body onload="focoInicial();">
        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-3"><h3>Receta Electr&oacute;nica</h3> </div>
                ...
                <form class="form-horizontal" role="form" name="formulario_receta" id="formulario_receta" method="get" action="../Receta">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-footer">
                            <div class="row">
                                <label for="sp_pac" class="col-sm-2 control-label">
                                    <button type="button" class="btn btn-default" data-placement="left" data-toggle="tooltip" data-placement="left" title="Buscar Paciente por folio de paciente" id="bus_pac"><span class="glyphicon glyphicon-search"></span></button>
                                    No. Paciente
                                </label>
                                <div class="col-sm-2">
                        ...
                        <div class="row">
                            ...
                            <a class="btn btn-info" onkeypress="return tabular(event, this);" href="../admin/pacientes/alta_pacientes2.jsp" >Nuevo paciente</a>
