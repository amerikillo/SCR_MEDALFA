        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <div class="panel panel-default">
                    <form class="form-horizontal" role="form" name="formulario_pacientes" id="formulario_pacientes" method="get" action="../../Usuarios">
                        <div class="panel-body">                            
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="usuario" name="usuario" placeholder="" onkeyup="" value=""/>
                                </div>
                                <label for="sexo" class="col-sm-1 control-label">Password</label>
                                <div class="col-sm-2">
                                    <input type="password" class="form-control" id="passw" name="passw" placeholder="" onkeyup="" value=""/>
                                </div>
                            </div>
                            <br />
                            <div class="row">
...
$(document).ready(function() {
    ...
    $('#Guardar').click(function() {
        ...
        if (ape_pat === "" || ape_mat === "" || nombre === "" || usuario === "" || password === "" || tipo === "0") {
